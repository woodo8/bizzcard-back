...
import { createNewCard, deleteCard, editCard, getAllCards, getCard, getLocation, getMyCards, incrementShareCount, visitTrackIncrement } from "../controllers/cardController.js";
...
router.post("/visitsIncrement/:cardId", visitTrackIncrement);
router.get("/sharesIncrement/:cardId", incrementShareCount);
router.post("/getLocation/:cardId", getLocation);
